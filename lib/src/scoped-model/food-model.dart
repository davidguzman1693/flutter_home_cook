...
class FoodModel extends Model {
  ...
  Future<bool> addFood(Food food) async {
    ...
    try {
      ...
      final http.Response response = await http.post(
          "https://foodle2-55872.firebaseio.com/foods.json",
  ...
  Future<bool> fetchFoods() async {
    ...
    try {
      final http.Response response =
          await http.get("https://foodle2-55872.firebaseio.com/foods.json");
  ...
  Future<bool> updateFood(Map<String, dynamic> foodData, String foodId) async{
    ...
    try{
      await http.put("https://foodle2-55872.firebaseio.com/foods/${foodId}.json", body: json.encode(foodData));
  ...
  Future<bool> deleteFood(String foodId) async{
    _isLoading = true;
    try {
      final http.Response response = await http.delete("https://foodle2-55872.firebaseio.com/foods/${foodId}.json"); 
      //Delete item from list food item+
